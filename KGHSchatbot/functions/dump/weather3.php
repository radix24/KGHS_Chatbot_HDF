...
function d2_weather()
{
  ...
  $data3[0] = "" . $month . " 월 " . $day . " 일의 경기고등학교 날씨 정보입니다. (기상청 제공, 서울특별시 강남구 청담동 기준)\\n\\n"
  $data3[1] = "현재 시간 온도 : " . $temp_now . "\\n";
  $data3[2] = "최고 온도 : " . $temp_max . "\\n";
  $data3[3] = "최저 온도 : " . $temp_min . "\\n";
  $data3[4] = "구름의 양 : " . $sky_status . "\\n";
  $data3[5] = "강수 상태 : " . $rain_status . "\\n";
  $data3[6] = "날씨 : " . $kor . "\\n";
  $data3[7] = "강수 확률 : " . $rain_posb . "%\\n";
  $data3[8] = "습도 : " . $hmdty . "%";
return $data3;
  }
