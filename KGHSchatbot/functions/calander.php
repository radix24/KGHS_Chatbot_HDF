...
function cal($req)
{
  ...
  if ( $month == 3 ) {
    ...
    $cal[0] = "<경기고등학교 " . $month . "월 학사일정> \\n\\n";//날짜 맞추려고 공백. 여기에 입력된 데이터는 출력되지 않음
    $cal[1] = "" . $month . "월 1일: 융합인재2기(2)\\n";
    $cal[2] = "" . $month . "월 2일: \\n";
    $cal[3] = "" . $month . "월 3일: 교과협의회\\n";
    $cal[4] = "" . $month . "월 4일: \\n";
    $cal[5] = "" . $month . "월 5일: 대수능모의평가(3), 학력평가 (1,2)\\n";
    $cal[6] = "" . $month . "월 6일: \\n";
    $cal[7] = "" . $month . "월 7일: 진로탐색(3), 심폐소생술교육\\n";
    $cal[8] = "" . $month . "월 8일: 융합인재2기(3)\\n";
    $cal[9] = "" . $month . "월 9일: \\n";
    $cal[10] = "" . $month . "월 10일: \\n";
    $cal[11] = "" . $month . "월 11일: \\n";
    $cal[12] = "" . $month . "월 12일: \\n";
    ...
    $cal[18] = "" . $month . "월 18일: \\n";
    $cal[19] = "" . $month . "월 19일: \\n";
    $cal[20] = "" . $month . "월 20일: 중간고사(1,2,3)\\n";
    $cal[21] = "" . $month . "월 21일: 중간고사(1,2,3)\\n";
    $cal[22] = "" . $month . "월 22일: \\n";
    $cal[23] = "" . $month . "월 23일: 추석연휴\\n";
    $cal[24] = "" . $month . "월 24일: 추석\\n";
    $cal[25] = "" . $month . "월 25일: 추석연휴\\n";
    $cal[26] = "" . $month . "월 26일: 대체공휴일\\n";
    $cal[27] = "" . $month . "월 27일: 중간고사(1,2,3)\\n";
    $cal[28] = "" . $month . "월 28일: 중간고사(1,2,3)\\n";
    $cal[29] = "" . $month . "월 29일: \\n";
    $cal[30] = "" . $month . "월 30일: ";
  $cal[31] = ""; //9월은 30일이니까 공백
    ...
    $cal[6] = "" . $month . "월 6일: \\n";
    $cal[7] = "" . $month . "월 7일: \\n";
    $cal[8] = "" . $month . "월 8일: 재량휴업일\\n";
    $cal[9] = "" . $month . "월 9일: 한글날\\n";
    $cal[10] = "" . $month . "월 10일: 교과협의회, 1,2,3 책읽기운동 (1)\\n";
    $cal[11] = "" . $month . "월 11일: STEAM2기(1)\\n";
    $cal[12] = "" . $month . "월 12일: 봉사활동 (1,2,3)\\n";
    $cal[13] = "" . $month . "월 13일: \\n";
    $cal[14] = "" . $month . "월 14일: \\n";
    $cal[15] = "" . $month . "월 15일: 수업공개및수업컨설팅, 상담주간 (~19)\\n";
    $cal[16] = "" . $month . "월 16일: 학력평가(3)\\n";
    $cal[17] = "" . $month . "월 17일: \\n";
    $cal[18] = "" . $month . "월 18일: 독서퀴즈대회, STEAM2기(2)\\n";
    $cal[19] = "" . $month . "월 19일: 자유인문화인평화인 그림그리기대회\\n";
    $cal[20] = "" . $month . "월 20일: 창의인재2기 (1)\\n";
    $cal[21] = "" . $month . "월 21일: \\n";
    $cal[22] = "" . $month . "월 22일: 이공계동아리활동 발표대회\\n";
    $cal[23] = "" . $month . "월 23일: \\n";
    $cal[24] = "" . $month . "월 24일: \\n";
    $cal[25] = "" . $month . "월 25일: STEAM2기 (3)\\n";
    $cal[26] = "" . $month . "월 26일: \\n";
    $cal[27] = "" . $month . "월 27일: 창의인재2기(2)\\n";
    $cal[28] = "" . $month . "월 28일: \\n";
    $cal[29] = "" . $month . "월 29일: 진로진학역량발표대회, 수학UCC마감\\n";
    $cal[30] = "" . $month . "월 30일: 진로진학역량발표대회\\n";
    $cal[31] = "" . $month . "월 31일: ";
  }
  else if ( $month == 11 ) {
        $cal[0] = "<경기고등학교 " . $month . "월 학사일정> \\n\\n";//날짜 맞추려고 공백. 여기에 입력된 데이터는 출력되지 않음
