    ...
    if ( strpos($content, "개발자") !== false ) {
      echo '{
        ...
        echo '{
              ...
              {
                "type" : "buttons",
                "buttons" : ["학생동 부스", "화동관 부스", "과학동 부스", "관리동 부스", "체육관 부스", "삼성재 (검도장) 부스", "문화관 부스"]
              }
            }';
    }
          ...
          echo '{
                "message" :
                {
                  "text" : "메인화면으로 돌아왔습니다. 재학생/방문자 메뉴 중에서 선택해주세요"
                },
                "keyboard" :
                {
                  "type" : "buttons",
      ...
      else if ( strpos($content, "화동제 방문자") !== false ) {
          echo '{
                "message" :
                {
      ...
      else if ( strpos($content, "재학생") !== false ) {
          echo '{
                "message" :
                {
                  "text" : "임시로 분리된 재학생 메뉴입니다. 원하시는 기능을 선택해주세요. 화동제 특별 기능이 임시로 추가되어 있습니다 :)"
                },
                "keyboard" :
                {
                  "type" : "buttons",
      ...
      else if ( strpos($content, "부스 안내") !== false ) {
          echo '{
                "message" :
                {
      ...
      else if ( strpos($content, "시설 안내") !== false ) {
          echo '{
                "message" :
                {
      ...
      //시설안내 세부메뉴 종료
      //행사안내 세부메뉴 시작
      else if ( strpos($content, "행사 안내") !== false ) {
          echo '{
                "message" :
                {
                  "text" : "준비중입니다"
